...
const GoldRetailGrid = () => {
	const gridRef = useRef();
	const containerStyle = useMemo(
		() => ({ width: "100%", height: "190px" }),
		[]
	);
	const gridStyle = useMemo(() => ({ height: "190px", width: "100%" }), []);
	...
	const [columnDefs, setColumnDefs] = useState([
		...
		{ field: "trType", headerName: "Tr.Type", editable: true, maxWidth: 100 },

		{ field: "code", headerName: "Item Code", editable: true, maxWidth: 100 },
